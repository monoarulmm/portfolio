                        ...
                        <div class="d-flex flex-wrap align-content-start h-100">
                            <div class="position-sticky clients-wrapper sticky-top rbt-sticky-top-adjust">
                                <ul class="nav tab-navigation-button flex-column nav-pills me-3" id="v-pills-tab"
                                    ...
                                    <li class="nav-item " style="margin-top:20px; margin-bottom:20px">
                            ...
                            <div class="d-flex align-items-start">
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="v-pills-Design" role="tabpanel"
                                                    ...
                                                    <div class="inner text-center">
                                                        <div class="thumbnail">
                                                            <a href="{{ url('client_details', $profile->id) }}">
                                                                @if ($profile->p_image)
                                                                    <img class="img_size"
                                                                        src="/storage/profile_photo/{{ $profile->p_image }}"
                                                                        alt="product_image""
                                        ...
                                        <div class="seperator"></div>
                                        <div class="client-name"><span><a href="{{ url('client_details', $profile->id) }}">
                                                    {{ $profile->name }}</a></span>
                                        </div>
                                    </div>
                                </div>
